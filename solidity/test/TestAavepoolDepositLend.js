...
describe("Deposit Lend Test", function () {
    ...
    describe("should deposit lend successfully", async () => {
        it("should deposit lend successfully", async () => {
            ...
            // 再次存入1000个usdc（但是先修改上次计息时间，方便测试计息的逻辑）
